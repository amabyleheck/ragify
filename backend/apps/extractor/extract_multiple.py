...
from backend.apps.extractor.embeddings.ingest import LocalVectorStoreGenerator
...
def extract(variables: dict, directory=""):
    ...
    vectorstore_generator = LocalVectorStoreGenerator(
        documents_ids=documents_ids, **embedding_kwargs
    )
    ...
    for prompt_dict in prompts:
        ...
        with torch.no_grad():  # useful for inference, reduce escaling memory consumption
            ...
            for id in documents_ids:
                ...
                extracted_dict[prompt_name][id] = {"value": value, "docs": docs}
                counter += 1
